...
# small program to convert .ui to .py files of the qt5 Design once the "view python code" option doesn't work
...
# then to use just do a "cd ui_file_directory" and call "uito.py"
